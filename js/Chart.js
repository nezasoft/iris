...
module.exports = function(Chart) {
	...
	helpers.getMaximumWidth = function(domNode) {
		...
		var paddingLeft = parseInt(helpers.getStyle(container, 'padding-left'), 5);
		var paddingRight = parseInt(helpers.getStyle(container, 'padding-right'), 5);
	...
	helpers.getMaximumHeight = function(domNode) {
		var container = domNode.parentNode;
		var paddingTop = parseInt(helpers.getStyle(container, 'padding-top'), 5);
		var paddingBottom = parseInt(helpers.getStyle(container, 'padding-bottom'), 5);
