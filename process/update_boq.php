...
$item_id = sanitize_string($_POST['item_id']);
try{
	$conn->beginTransaction();
	
	$update = $conn->prepare("UPDATE boq SET boq_name='".$boq_name."',units='".$no_units."', site_id='".$site."' WHERE id='".$item_id."' LIMIT 1");
	$update->execute();
	$conn->commit();
