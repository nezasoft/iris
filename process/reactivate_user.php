...
$del = mysql_query("update users set account_status = 'Active' where user_id='$user_id'");
...
window.location.href="?account_type='.$_SESSION['COMSYS_AccountType'].'&site_id='.$_SESSION['COMSYS_SiteID'].'&sec=us&act=man_users";
	...
	echo '<span class="error">Error occured while reactivating user account. Please try again'.mysql_error().'</span>';
}
