...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	$est_cost = sanitize_string($_POST['est_cost']);
	...
	try{
		 ...
		 //save data
		 $save = $conn->prepare("INSERT INTO sites(site_name,site_phone,site_email,site_postal,site_address,date_created,site_status,site_code,estimated_cost)VALUES('".$site_name."','".$phone_no."','".$email."','".$postal."','".$physical."',curdate(),'Active','".$site_code."','".$est_cost."')");
		 $save->execute();
		  $log_desc ="Added a new site   <strong>".$site_name."</strong>";
		  //Log Activity
