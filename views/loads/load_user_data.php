     ...
     if($row_count!=0){
        ...
        if($role_count!=0){
			...
			<div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5 table-striped" id="list_users" >
...
$('#list_users').Tabledit({
    url: 'process/update_user.php', editButton: true, removeButton: true, columns: {
        identifier: [0, 'id'], editable: [ [1, 'fName'],[2, 'sName'],[3, 'Email'],[4, 'Username'], [5, 'Site',<?php  echo $sites;?>],[6, 'Role',<?php  echo $roles;?>],[8, 'Status', '{"Yes": "Active", "No": "In-active"}']]
    }
    , buttons: {
        edit: {
