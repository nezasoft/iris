...
?>
      	<div>
			<div class="table-responsive">
                <table class="table table-row-dashed table-striped table-row-gray-300 align-middle gs-0 gy-4" id="site_requisition_data" >
            ...
            ?>
              <tr>  
				  ...
				  <td>
				  <?php if($item6==1){ ?><div align="center"><a href="#" class="badge badge-success" data-bs-toggle="modal" data-bs-target="#ModalContentViewItem" onclick="viewTransaction(<?php echo $row['order_no']; ?>)"> View</a> 
				  </div> <?php } ?>
				  </td>
              </tr>   
            <?php
...
filter = <?php  echo $filter; ?>;
	...
	var myData = 'page=' + pageno + '&filter=' + filter;
     ...
     url: "views/loads/load_site_requisitions_data.php", //Where form data is sent on submission
...
?>
<script>
$("#site_requisition_data").tableExport({
  ...
  fileName: "Site Requisition Report",                         
  ...
  sheetname: "Site Requisition Report" 
