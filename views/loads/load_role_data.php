		...
		return $setPaginate;
            ...
            ?>
              ...
              <td><?php echo $row['item_id']; ?></td>
				  ...
				  <td><div align="right"><a href="#" class="badge badge-success" onclick="addPermission()"> Add Permission(s)</a> 
				  <a href="#" onclick="viewPermission()" class="badge badge-info"> View Permissions</a>
				  </div>
				  </td>
              </tr>   
            <?php
