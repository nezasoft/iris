...
unit_id = <?php echo $unit_id; ?>;
	...
	var myData = 'page=' + pageno + '&filter=' + filter + '&unit_id='+unit_id;
     ...
     url: "views/reports/loads/load_unit_requisitions_data.php", //Where form data is sent on submission
