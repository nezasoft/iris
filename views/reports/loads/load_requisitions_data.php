...
?>
      	<div>
			<div class="table-responsive">
                <table class="table table-row-dashed table-striped table-row-gray-300 align-middle gs-0 gy-4"id="requisitions_data" >
            ...
            ?>
              <tr>  
				  ...
				  <td>
				  <div align="center"><a href="#" data-bs-toggle="modal" data-bs-target="#ModalContentViewItem" class="badge badge-success"  onclick="viewTransaction(<?php echo $row['order_no']; ?>)"> View</a> 
				  </div>
				  </td>
              </tr>   
            <?php
...
?>
<script>
function getdata(pageno,filter,filter_form_data,t_type,from,to,site){
//empty response
...
site = "<?php  echo $site; ?>";
	// source of data	
	var myData = 'page=' + pageno + '&filter=' + filter + '&filter_form_data=' + filter_form_data  + '&t_type=' + t_type  + '&from=' + from  + '&to=' + to + '&site=' + site ;
	 jQuery.ajax({
     type: "GET", // Post / Get method
     url: "views/reports/loads/load_requisitions_data.php", //Where form data is sent on submission
     dataType:"text", // Data type, HTML, json etc.
