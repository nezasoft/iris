...
$('#po_items').Tabledit({
    //Delete PO Item
    url: 'process/update_po_details.php', editButton: true, removeButton: true, columns: {
        identifier: [0, 'id'], editable: [ [7, 'Quantity'], [9, 'Rate']]
    }
    , buttons: {
        edit: {
            class: 'btn btn-sm btn-default', html: '<span class="glyph-icon icon-pencil-square-o"></span>', action: 'edit'
        }
        , delete: {
            class: 'btn btn-sm btn-default', html: '<span class="glyph-icon  icon-trash"></span>', action: 'delete'
        }
        , save: {
